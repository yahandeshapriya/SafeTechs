import getPromisedMarkers from "./locations";
const key = "your_key";


export const G_API_URL = `https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry,drawing,places&key=AIzaSyDAsJYZSQ92_NQAz9kiSpW1XpyuCxRl_uI`;
...
export const latLngConverter = (latLng, title) => {
  return {
    latLng,
    title
  };
...
export const locationsList = {
  ...
  Horana: convertTolatLng("6.718564559, 80.0696375", "Horana"),
  Pokunuwita: convertTolatLng("6.72065296, 80.019727022", "Stop 01"),
  Stop02: convertTolatLng("6.76702180, 80.01852539", "Stop 02"),
  Stop03: convertTolatLng("6.78577264, 79.98676803", "Stop 03"),
  Stop04: convertTolatLng("6.78577264, 79.98676803", "Stop 04"),
  Stop05: convertTolatLng("6.8784932983, 79.873643190", "Stop 05"),
};

export const dbLocationsList = () => {
  ...
  // console.log(await getPromisedMarkers());
  return locations;
}
