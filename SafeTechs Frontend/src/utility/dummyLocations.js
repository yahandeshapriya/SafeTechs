import { locationsList, dbLocationsList } from "./constants";
import { createLocationObject } from "./helper";

const locations = dbLocationsList();
...
const directions = [
  ...
  // },
  {
    from: locations.Horana,
    to: locations.Stop02,
    strokeColor: "#f68f54"
  },
  {
    from: locations.Stop02,
    to: locations.Stop03,
    strokeColor: "#f68f54"
  },
  {
    from: locations.Stop03,
    to: locations.Stop04,
    strokeColor: "#f68f54"
  },
  // {
  //   from: locations.Stop04,
  //   to: locations.Stop05,
  //   strokeColor: "#f68f54"
  // },
  // {
  //   from: locationsList.Stop05,
  //   to: locationsList.Kandy,
  //   strokeColor: "#f68f54"
  // }
