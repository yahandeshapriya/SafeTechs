...
function Register() {
    ...
    const onRegisterStaff = () => {
        ...
        if(username||name||address||contact||email||pass||cpass) {
            const staff = new StaffMember(username, email, pass, name, contact, address, 'Operational Employee', 'STF234' );
            employee_service.addPatient(staff);
        } else {
            ...
            <div className="form-col text-center"  >
                {
                    !patState?
                        <>
                            ...
                            <h1 className="ct-font-Primary" >As a Staff Member</h1>  
                        </>
                        :
                        <>
                            <h4 className="ct-font-Primary" >RRD Staff Registration</h4>  
                            <form onSubmit={(event)=>{event.preventDefault(); onRegisterStaff();}}>
                                <div class="form-group ct-input-padding-fix">
                                    ...
                                    />
                                        <small className="form-text text-muted ct-font-Primary">{sm_name}</small>
                                </div>
                                ...
                                <div class="form-group ct-input-padding-fix">
                                    ...
                                    />
                                    <small className="form-text text-muted ct-font-Primary">{sm_uname}</small>
                                </div>
                                <div className="hr-spacer"></div>
                                ...
                                <div class="form-group ct-input-padding-fix">
                                    ...
                                    />
                                    <small className="form-text text-muted ct-font-Primary">{sm_address}</small>
                                </div>
                                <div className="hr-spacer"></div>
                                ...
                                <div class="form-row ct-flex">
                                    <div class="col">
                                        ...
                                        />
                                        <small className="form-text text-muted ct-font-Primary">{sm_contact}</small>
                                    </div>
                                    <div class="col">
                                        <input 
                                        ...
                                        />
                                        <small className="form-text text-muted ct-font-Primary">{sm_email}</small>
                                    </div>
                                </div>
                                <div className="hr-spacer"></div>
                                ...
                                <div class="form-row ct-flex">
                                    <div class="col">
                                        ...
                                        />
                                        <small className="form-text text-muted ct-font-Primary">{sm_pass}</small>
                                    </div>
                                    <div class="col">
                                        <input 
                                        ...
                                        />
                                        <small className="form-text text-muted ct-font-Primary">{sm_cpass}</small>
                                    </div>
                                </div>
                                <div className="hr-spacer"></div>
            ...
            <div className="form-col text-center">
                {
                    !expState?
                        <>
                            ...
                            <h1 className="ct-font-Primary">As a Administrator</h1>
                        </>
                        :
                        <>
                            <h4 className="ct-font-Primary" >Administrator Registration</h4>    
                            <form onSubmit={(event)=>{event.preventDefault(); onRegisterExpert();}}>
                                <div class="form-group ct-input-padding-fix">
                                    ...
                                    />
                                        <small className="form-text text-muted ct-font-Primary">{sm_name_ex}</small>
                                </div>
                                <div className="hr-spacer"></div>
                                <div class="form-group ct-input-padding-fix">
                                    {/* <label for="inputusername">Username</label> */}
                                    ...
                                    />
                                        <small className="form-text text-muted ct-font-Primary">{sm_uname_ex}</small>
                                </div>
                                <div className="hr-spacer"></div>
                                ...
                                <div class="form-group ct-input-padding-fix">
                                    ...
                                    />
                                        <small className="form-text text-muted ct-font-Primary">{sm_address_ex}</small>
                                </div>
                                ...
                                <div class="form-row ct-flex">
                                    ...
                                    />
                                    <small className="form-text text-muted ct-font-Primary">{sm_contact_ex}</small>
                                    </div>
                                    <div class="col">
                                    <input 
                                        ...
                                        type="text" class="form-control" placeholder="Your Email"
                                    />
                                    <small className="form-text text-muted ct-font-Primary">{sm_email_ex}</small>
                                    </div>
                                </div>
                                <div className="hr-spacer"></div>
                                <div class="form-row ct-flex">
                                    ...
                                    />
                                    <small className="form-text text-muted ct-font-Primary">{sm_pass_ex}</small>
                                    </div>
                                    <div class="col">
                                    <input 
                                    ...
                                    />
                                    <small className="form-text text-muted ct-font-Primary">{sm_cpass_ex}</small>
                                    </div>
                                </div>
                                <div className="hr-spacer"></div>
                                <div className="text-center">
