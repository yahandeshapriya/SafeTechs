                    ...
                    form_state?
                        <>
                            <div className="ct-pupup-head text-center">
                                ...
                                <h1 className="ct-font-primary">LOGIN</h1>
                                ...
                                <form onSubmit={(event)=>{event.preventDefault(); onLogin(username, password);}}>
                                    <div class="form-group ">
                                        ...
                                        />
                                        <small id="emailHelp" className="form-text text-muted ct-font-primary">Use Username that was given by you in Registration.</small>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div className="form-col">
                                <h1 className="ct-font-primary">Welcome to Sri Lanka's First Automated Vehicle Accident Detection & Alerting System </h1>
                                <p className="ct-font-primary"></p>
                                <p className="ct-font-primary">Haven't got an <a href="#" onClick={swapPannel}>Account</a>?</p>
                                </div>
